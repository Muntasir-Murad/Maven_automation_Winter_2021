...
public class MLC_TestNG {
    ...
    @BeforeSuite
    public void preconditions() throws IOException, InterruptedException, BiffException, BiffException {
        ...
        Workbook readableBook = Workbook.getWorkbook(new File("src/main/resources/Mlc_datadriven.xls"));

        //Step 2: create a writable workbook that will mimic the data from readable
        writableWorkbook = Workbook.createWorkbook(new File("src/main/resources/Mlc_datadriven_Result.xls"),readableBook);
